 ...
 */
final class Version20250903193912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, image_link VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, short_description VARCHAR(255) NOT NULL, `ranked` INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, image_link VARCHAR(255) NOT NULL, stock_quantity INT NOT NULL, slug VARCHAR(255) NOT NULL, short_description VARCHAR(255) NOT NULL, long_description VARCHAR(255) NOT NULL, additional_details VARCHAR(255) NOT NULL, `ranked` INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, sub_category_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, short_description VARCHAR(255) NOT NULL, long_description VARCHAR(255) NOT NULL, additional_details VARCHAR(255) NOT NULL, service_duration DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, image_link VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, `ranked` INT NOT NULL, featured_landing TINYINT(1) DEFAULT 0 NOT NULL, featured_rank INT DEFAULT NULL, INDEX IDX_E19D9AD2F7BFE87C (sub_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sub_category (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, label VARCHAR(255) NOT NULL, image_link VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, `ranked` INT NOT NULL, INDEX IDX_BCE3F79812469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
