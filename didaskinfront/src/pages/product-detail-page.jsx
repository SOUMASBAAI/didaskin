...
export default function ProductDetailPage() {
  ...
  const additionalDetailsText =
    (product && (product.additionalDetails || product.AdditionalDetails)) || "";
  const additionalDetails = additionalDetailsText
      ...
      <main className="flex-grow pt-32 pb-12 px-4 md:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto flex flex-col lg:flex-row gap-x-16 gap-y-8">
          ...
          <div className="lg:w-1/2 flex flex-col justify-start lg:pt-0 pt-8">
            ...
            <button className="w-full py-3 px-6 bg-black text-white font-medium tracking-wide rounded-none  mb-6">
