...
export default function NewsletterSection() {
  ...
  const fetchNewsletters = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${RESOURCE_ENDPOINTS.NEWSLETTERS}/newsletter`,
        {
  ...
  const handleAddNewsletter = async (e, send = false) => {
    ...
    try {
      const response = await fetch(`${RESOURCE_ENDPOINTS.NEWSLETTERS}/new`, {
        method: "POST",
        headers: {
  ...
  const handleEditNewsletter = async (e, send = false) => {
    ...
    try {
      const response = await fetch(
        `${RESOURCE_ENDPOINTS.NEWSLETTERS}/${editNewsletterId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteNewsletter = async (id) => {
    ...
    try {
      const response = await fetch(`${RESOURCE_ENDPOINTS.NEWSLETTERS}/${id}`, {
        method: "DELETE",
        headers: getAuthHeaders(),
      });
